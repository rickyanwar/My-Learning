...
import { View, StyleSheet, Text, Animated, ScrollView, TouchableOpacity, Modal, TouchableWithoutFeedback } from 'react-native';
...
const FilterModal = ({ isVisible, onClose }) => {
            ...
            >
                ...
                >
                    <TwoPointSlider
                        ...
                        prefix="$"
                        postfix=""
                        onValuesChange={() => console.log(values)}
                    />
                </View>
            </Section>
        )
    ...
    const modalY = modalAnimatedValue.interpolate({
        inputRange: [0, 1],
        outputRange: [SIZES.height, SIZES.height - 540]
    })
    return (
        <Modal
            animationType='fade'
